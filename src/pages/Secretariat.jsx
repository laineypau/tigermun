    ...
    <div style={{
      ...
      <div style={{ position: 'relative', flexShrink: 0 }}>
        <img src={p.img} alt={p.name} style={{
          width: 180, height: 224, objectFit: 'cover', borderRadius: 'var(--radius-md)',
        }} />
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: 16, padding: 20, alignItems: 'center', borderBottom: '1px solid var(--border-hair)' }}>
        <img src={p.img} alt={p.name} style={{ width: 96, height: 96, borderRadius: '999px', objectFit: 'cover', border: '3px solid var(--white)', boxShadow: '0 0 0 2px var(--sky-300)' }} />
        <div>
